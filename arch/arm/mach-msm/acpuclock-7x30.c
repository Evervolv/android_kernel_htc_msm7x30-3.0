...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1, 1200000, PLL_2, 3, 0, 192000000, 1050, VDD_RAW(1050), &pll2_tbl[2]},
	{ 1, 1401600, PLL_2, 3, 0, 192000000, 1150, VDD_RAW(1150), &pll2_tbl[3]},
#ifdef CONFIG_JESUS_PHONE
	{ 1, 1516800, PLL_2, 3, 0, 192000000, 1200, VDD_RAW(1200), &pll2_tbl[4]},
	...
	{ 1, 1900800, PLL_2, 3, 0, 192000000, 1450, VDD_RAW(1450), &pll2_tbl[10]},
#endif
	{ 0 }
};
